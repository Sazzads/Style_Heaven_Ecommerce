        ...
        <div className='my-10'>
            ...
            <div className='relative'>
                ...
                <div className='absolute top-1/3 left-32 right-32 text-white'>
                    <div className='text-center space-y-3 hidden md:block'>
                        <h6 className='text-pink-300 '>T&nbsp; R&nbsp; E&nbsp; N&nbsp; D&nbsp; I&nbsp; N&nbsp; G</h6>
                        <h2 className='text-xs md:text-4xl'>New Fashion</h2>
                        <p className=''>Discover the future of fashion with our handpicked collection of the <br />  latest trends. Embrace innovation, style,
                            and individuality .</p>
