    ...
    return (
        <div className=''>
            <div className='h-[50px] bg-[#2d3436] flex items-center justify-around text-white'>
                <div className='hidden md:block'>Support +88 01 733 4398 12</div>
                <div className='hidden md:block'>Free US shipping an all orders $100+ Learn more</div>
                <div className=''>
                    ...
                    <div className="dropdown dropdown-hover">
                        ...
                        <ul tabIndex={0} className="dropdown-content z-[1] menu  shadow bg-[#2d3436] ">
                            <li><a>Spanish</a></li>
                            <li><a>Bangla</a></li>
                        </ul>
                    </div>
